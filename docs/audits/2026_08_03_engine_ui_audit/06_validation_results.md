...
| `python tools/validate_deploy_contract.py --deploy-root events/2026_Finished_Events/2026_the_open_championship/deploy --strict` | 1 | Undeclared dynamic `data/r${r}_analysis.json`; warning that single-file board has no literal stylesheet reference. |
